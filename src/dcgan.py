...
parser.add_argument(
    "--accel", action="store_true", default=False, help="enables accelerator"
)
...
print("\n[INFO] Gerando imagem com o modelo não treinado...")

# Criar um vetor de ruído fixo (64 imagens de exemplo em um grid)
fixed_noise = torch.randn(64, nz, 1, 1, device=device)

# Passar o ruído pelo gerador para criar uma "imagem" falsa
with torch.no_grad():
